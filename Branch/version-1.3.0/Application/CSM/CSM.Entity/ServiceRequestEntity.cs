...
//        public int OldSrStatusId { get; set; }
    ...
    [Serializable]
    public class ServiceRequestSaveSrReportResult : ServiceRequestSaveResult
    {
        public ServiceRequestSaveSrReportResult() { }

        public ServiceRequestSaveSrReportResult(bool isSuccess, string errorMessage = "", int? srId = null, string errorCode = "", string srNo = null)
        {
            IsSuccess = isSuccess;
            ErrorMessage = errorMessage;
            SrId = srId;
