...
namespace CSM.Business
{
    public class ServiceRequestFacade : IServiceRequestFacade
    {
        ...
        public ServiceRequestSaveResult CreateServiceRequest(AuditLogEntity auditLog, ServiceRequestForSaveEntity entity, bool isSaveDraft)
        {
            ...
            else
            {
                ...
                if (entity.SrAttachments != null && entity.SrAttachments.Count > 0)
                {
                    ...
                    //if (entity.IsJob) _serviceRequestDataAccess.CreateSrAttachmentDocumentType(entity.SrAttachments, createUserId);
                }
        ...
        private bool SendEmail(ServiceRequestSaveActivityResult entity, List<SrAttachmentEntity> list)
        {
            ...
            return CSMMailSender.GetCSMMailSender().SendMail(senderEmail, receiverEmails, ccEmails, subject, message, attachmentStreams, attachmentFilenames, isSensitive);
        }
        ...
        public ServiceRequestSaveResult CopyServiceRequest(ServiceRequestForSaveEntity entity)
        {
            var warningMessages = new List<string>();

            //Create SR Number
            int newSeq = new CommonDataAccess(_context).GetNextServiceRequestSeq();
            entity.SrNo = ApplicationHelpers.GenerateSrNo(newSeq);
            ...
            // Save to TB_T_SR
            _serviceRequestDataAccess = new ServiceRequestDataAccess(_context);
            _serviceRequestDataAccess.CopyServiceRequest(entity);

            return new ServiceRequestSaveResult
            {
                IsSuccess = true,
                WarningMessages = warningMessages,
                SrNo = entity.SrNo != null ? entity.SrNo : null
            };
        }
