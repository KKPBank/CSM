...
namespace CSM.Common.Utilities
{
    public static class Constants
    {
        ...
        public static class CisMaxLength
        {
            ...
            public const int SourceIncomeRem = 50;
        ...
        public static class ReplyMail
        {
            ...
            public static string GetMessage(short? replyMail)
            {
                if (replyMail == N)
                {
                    return Resource.Ddl_ReplyMail_N;
                }

                if (replyMail == Y)
                {
                    return Resource.Ddl_ReplyMail_Y;
                }

                if (replyMail == All)
                {
                    return Resource.Ddl_ReplyMail_All;
                }
