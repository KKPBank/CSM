...
namespace CSM.Web.Models
{
    ...
    public class PoolViewModel
    {
        ...
        public SelectList ReplyMailList { get; set; }
        [Display(Name = "Lbl_ReplyMail", ResourceType = typeof(CSM.Common.Resources.Resource))]
        public short? ReplyMail { get; set; }

        public int? PoolEmailTemplateId { get; set; }
        public string PoolEmailTemplateName { get; set; }
        public List<SelectListItem> PoolEmailTemplates { get; set; }
