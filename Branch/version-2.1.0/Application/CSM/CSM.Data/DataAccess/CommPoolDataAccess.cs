...
namespace CSM.Data.DataAccess
{
    public class CommPoolDataAccess : ICommPoolDataAccess
    {
        ...
        public bool AddMailContent(List<CommunicationPoolEntity> mailMessages, ref int refNumOfSR, ref int refNumOfFax, ref int refNumOfWeb, ref int refNumOfEmail, ref int refNumOfKKAM)
        {
            try
            {
                                    ...
                                    if (this.Save() > 0)
                                    {
                                        switch (mail.ChannelEntity.Code)
                                        {
                                            ...
                                            case Constants.ChannelCode.Email:
                                                refNumOfEmail += 1;
                                                break;
                                            case Constants.ChannelCode.KKAsset:
                                                refNumOfKKAM += 1;
                                                break;
                                            default:
                                                break;
