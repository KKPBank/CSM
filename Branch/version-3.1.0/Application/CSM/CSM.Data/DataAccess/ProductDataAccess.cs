...
namespace CSM.Data.DataAccess
{
    public class ProductDataAccess : IProductDataAccess
    {
        ...
        public IEnumerable<string> GetAccountTypeList(string custProdType)
        {
            return (from at in _context.TB_M_ACCOUNT_TYPE
                    where (custProdType == Constants.CustomerProduct.Loan ?
                            at.ACCOUNT_TYPE_CODE == Constants.AccountType.LoanAccount
                            : at.ACCOUNT_TYPE_CODE != Constants.AccountType.LoanAccount)
