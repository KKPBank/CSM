...
namespace CSM.Web.Models
{
    ...
    public class CustomerViewModel
    {
        ...
        public SelectList CustomerProductList { get; set; }
        ...
        public int CustomerHPCount { get; set; }
        public string InquiryCBSErrorMessage { get; set; }
    ...
    public class LookupCustomerViewModel
    {
        ...
        //public IEnumerable<CustomerEntity> CustomerTableList { get; set; }
