    ...
    public class BaseController : Controller
    {
        ...
        protected CustomerInfoViewModel MappingCustomerInfoView(int customerId)
        {
            using (var customerFacade = new CustomerFacade())
            {
                ...
                custInfoVM.CbsCardType = customerEntity.CbsCardType;
                ...
                custInfoVM.EmployeeCode = customerEntity.EmployeeCode;
                return custInfoVM;
            }
        }
        ...
        protected System.Net.WebProxy getWebProxy()
        {
            ...
            string[] cfProxy = "Y|10.3.35.199|80".Split('|');
            if (cfProxy.Length == 3)
            {
                if (cfProxy[0] == "Y")
                {
        ...
        protected void SaveServiceRequestLog(string req) {
            CommonFacade _commonFacade = new CommonFacade();
        ...
        protected void SaveServiceResponseLog(string res)
        {
            CommonFacade _commonFacade = new CommonFacade();
            if (_commonFacade.GetFlagCbsSaveLog() == true)
            {
