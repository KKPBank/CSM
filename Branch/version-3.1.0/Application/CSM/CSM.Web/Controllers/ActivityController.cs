...
namespace CSM.Web.Controllers
{
    ...
    public class ActivityController : BaseController
    {
        ...
        public ActionResult List(string encryptedString)
        {
            ...
            Logger.Info(_logMsg.Clear().SetPrefixMsg("InitSearch ActivityLog").Add("CustomerId", customerId).Add("CustomerNumber", customerNumber).ToInputLogString());
            ...
            try
            {
                ...
                {
                    activityVM.CustomerInfo = (CustomerInfoViewModel)TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()];
                    TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()] = activityVM.CustomerInfo;
                }
                ...
                var cbsCardType = activityVM.CustomerInfo.CbsCardType;
                ...
                activityVM.SearchFilter = new ActivitySearchFilter
                {
                    ...
                    CardNo = activityVM.CustomerInfo.CardNo,
                    CardTypeCode = cbsCardType != null ? cbsCardType.CardTypeCode : null,
                    PageNo = 1,
