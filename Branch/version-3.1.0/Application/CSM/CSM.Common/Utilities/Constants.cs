...
namespace CSM.Common.Utilities
{
    public static class Constants
    {
        ...
        public const string DefaultCardTypeForUser = "090";
        ...
        public static class AccountStatus
        {
            ...
            public static string GetMessage(string status)
            {
                ...
                {
                    return InstructionStatus.GetMessage(status);
                }
            }
        }
        ...
        public static class AccountType {
            public const string CurrentAccount = "D";
            public const string SavingsAccount = "S";
            public const string TermDepositAccount = "T";
            public const string LoanAccount = "L";
            public const string SpecialAccount = "X";
            public const string ServiceWithBank = "SB";
            public const string HirePurchase = "HP";
            ...
            public static string GetMessage(string type) {
                ...
                if (CurrentAccount.Equals(type))
                    ...
                    ret = "Savings Account";
                else if (TermDepositAccount.Equals(type))
                    ret = "Term Deposit Account";
                else if (LoanAccount.Equals(type))
                    ret = "Loan Account";
                else if (SpecialAccount.Equals(type))
                    ret = "Special Account";
                else if (ServiceWithBank.Equals(type))
                    ret = "Service with Bank";
                else if (HirePurchase.Equals(type))
                    ret = "Hire Purchase";
        ...
        //public static class CisMasterStatus
        //{
        //    public const string Active = "A";
        //    public const string Inactive = "I";
        ...
        public static class DateTimeFormat
        {
            ...
            public const string WebserviceReferenceNoDateTime = "yyyyMMddHHmmssfff";
            public const string WebserviceHPDateTime = "yyyyMMddHHmmss";
        }
        ...
        public static class ParameterName
        {
            ...
            public const string InlineContentLimit = "INLINE_CONTENT_LIMIT"; // Email inline content size limit in Byte

            public const string CASAStatementHisMonth = "CASA_STATEMENT_HIS_MONTH";
            public const string CbsSaveLog = "CBS_SAVE_LOG";
            public const string WSMaxReturnRows = "WS_MAX_RETURN_ROWS";
        }
        ...
        public static class ServiceName
        {
            ...
            public const string InquiryCustomerByInformation = "InquiryCustomerByInformation";
            public const string InquiryCustomerByAccount = "InquiryCustomerByAccount";
            public const string InquiryInstructionWithBank = "InquiryInstructionWithBank";
            public const string InquiryCustomerAddress = "InquiryCustomerAddress";
            public const string InquiryCustomerContact = "InquiryCustomerContact";
            public const string InquiryServiceWithBank = "InquiryServiceWithBank";
            public const string InquiryCustomerAccountSummary = "InquiryCustomerAccountSummary";
            public const string InquiryAccountAddress = "InquiryAccountAddress";
            public const string InquiryCASAAccountDetail = "InquiryCASAAccountDetail";
            public const string InquiryCASAStatementHistory = "InquiryCASAStatementHistory";
            public const string InquiryTDAccountByGroup = "InquiryTDAccountByGroup";
            public const string InquiryTDAccountDetail = "InquiryTDAccountDetail";
            public const string InquiryLoanAccountOverview = "InquiryLoanAccountOverview";
            public const string InquiryCustomerContractList = "InquiryCustomerContractList";
        }
        ...
        public static class CustomerWebServiceType {
            public const string CustomerByInformation = "CustomerByInformation";
            public const string CustomerByAccount = "CustomerByAccount";
            public const string CustomerByHP = "CustomerByHP";
            public const string CustomerByInsurance = "CustomerByInsurance";
            public const string CustomerPostpect = "CustomerPostpect";
        }
        ...
        public static class CbsCardTypeCode
        {
            public const string Personal = "001"; //"01";
        }
        ...
        {
            public const string ForeignAddress = "F";
            public const string LocalAddress = "L";
            public const string Unstructure = "U";
        }
        ...
        public static class BatchProcessCode
        {
            ...
            public const string ImportCBS = "I";
        ...
        public static class CAR_DataItemLableEntity
        {
            ...
            {
                public const string SubType = "ID Type";
                public const string SubId = "ID Number";
            ...
            public static class ContractInfo
            {
                ...
                public const string SubscriptionTypeName = "ID Type";
                public const string CardNo = "ID Number";
