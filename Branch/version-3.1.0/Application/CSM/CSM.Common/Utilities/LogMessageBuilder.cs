...
namespace CSM.Common.Utilities
{
    public class LogMessageBuilder : Dictionary<string, string>
    {
        ...
        public string ToInputLogString()
        {
            ...
            builder.AppendLine("ElapsedTime: " + ElapseTime + ": TotalTime: " + TotalTime + ": I:--START--");

            if (!string.IsNullOrEmpty(_prefixMsg))
                builder.AppendLine(":--" + _prefixMsg + "--");
        ...
        {
            var builder = new StringBuilder();
            builder.AppendLine("ElapsedTime: " + ElapseTime + ": TotalTime: " + TotalTime + ": O");
        ...
        {
            var builder = new StringBuilder();
            builder.AppendLine("ElapsedTime: " + ElapseTime + ": TotalTime: " + TotalTime + ":O:--SUCCESS--");
        ...
        {
            var builder = new StringBuilder();
            builder.AppendLine("ElapsedTime: " + ElapseTime + ": TotalTime: " + TotalTime + ":O:--FAIL--");
