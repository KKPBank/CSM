...
//        public int OldSrStatusId { get; set; }
    ...
    public class ServiceRequestForInsertLogEntity
    {
        ...
        public string CustomerCardTypeName { get; set; }
        public string CustomerCardTypeCode { get; set; }
        public string CustomerCardNo { get; set; }
        ...
        public int ContactId { get; set; }
        public string ContactCardTypeName { get; set; }
    ...
    public class ServiceRequestForSaveEntity
    {
        ...
        public string CustomerCardTypeCode { get; set; }
        public string CustomerCardTypeName { get; set; }
        //public string CustomerSubscriptTypeCode { get; set; }
        //public string CustomerSubscriptTypeName { get; set; }
        public string CustomerTitleTh { get; set; }
        public string CustomerFNameTh { get; set; }
        public string CustomerLNameTh { get; set; }
        public string CustomerTitleEn { get; set; }
        public string CustomerFNameEn { get; set; }
        public string CustomerLNameEn { get; set; }
        ...
        public string AccountProductGroup { get; set; }
        public string AccountProduct { get; set; }
        public string AccountProductDesc { get; set; }
        ...
        public string AccountSubscriptionCode { get; set; }
        public string AccountSubscriptionDesc { get; set; }
    ...
    public class ServiceRequestCustomerSearchResult
    {
        ...
        public CbsCardTypeEntity CardType { get; set; }
        
        public List<ServiceRequestCustomerAccountPhone> PhoneList { get; set; }

        public decimal? CustomerNo { get; set; }
        public string EmployeeCode { get; set; }
        public TitleEntity TitleTH { get; set; }
        public TitleEntity TitleEN { get; set; }
        public DateTime? BirthDate { get; set; }
        public string BirthDateDisplay
        { get {
                if (BirthDate.HasValue)
                {
                    return BirthDate.Value.ToString(Constants.DateTimeFormat.DefaultShortDate);
                }
                return string.Empty;
            } }
    }
    ...
    public class ServiceRequestContactSearchResult
    {
        ...
        public string CbsCardTypeName { get; set; }
