...
namespace CSM.Business
{
    public class ActivityFacade : BaseFacade, IActivityFacade
    {
        ...
        private List<ActivityDataItem> getLocalActivity(ActivitySearchFilter searchFilter)
        {
            ...
            var actCSM = srData.GetSrActivityQueryable(searchFilter.SrOnly, srData.GetServiceRequestNoDetail(searchFilter.SrNo)?.SrId, searchFilter.CustomerId, searchFilter.CustomerNo).ToList();
        ...
        public ServiceRequestSaveCarResult InsertActivityLogToCAR(AuditLogEntity auditLog, ServiceRequestForInsertLogEntity entity)
        {
            ...
            try
            {
                ...
                customerInfoList.Add(new CAR.DataItem { SeqNo = ++seqNo, DataLabel = DataLabel.CustomerInfo.SubType, DataValue = entity.CustomerCardTypeName });
                ...
                contractInfoList.Add(new CAR.DataItem { SeqNo = ++seqNo, DataLabel = DataLabel.ContractInfo.SubscriptionTypeName, DataValue = entity.ContactCardTypeName });
                ...
                var activitiyLogData = new CAR.CreateActivityLogData
                {
                    ...
                    SubscriptionTypeID = entity.CustomerCardTypeCode,
                    SubscriptionID = entity.CustomerCardNo,
                    LeadID = null,
                    TicketID = null,
                    SrID = entity.SrNo,
        ...
        private InquiryActivityLogResponse InquiryActivityLog(AuditLogEntity auditLog, ActivitySearchFilter searchFilter)
        {
            ...
            try
            {
                ...
                var activitiyLogData = new CAR.InqueryActivityLogData
                {
                    ...
                    ChannelID = null,
                    SubscriptionTypeID = searchFilter.SrOnly ? string.Empty : searchFilter.CardTypeCode, 
                ...
                try
                {
                    Retry.Do(() =>
                    {
                        ...
                        //if (resActivity != null)
                        //    SaveServiceResponseLog(resActivity.SerializeObject());
                ...
                if (resActivity != null)
                {
                    ...
                    if (Constants.ActivityResponse.Success.Equals(response.StatusResponse.ErrorCode))
                    {
                        ...
                        {
                            Logger.Debug($"\r\nInquiryActivityLog Return {resActivity.InquiryActivityDataList.Count()} row(s).\r\n");
