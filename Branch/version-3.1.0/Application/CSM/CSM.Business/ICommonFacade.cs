...
namespace CSM.Business
{
    public interface ICommonFacade : IDisposable
    {
        ...
        TitleEntity GetTitleById(int titleId, string Language);
        BankEntity GetBankByBankNo(string bankNo);
        //IDictionary<string, string> GetSubscriptTypeSelectList();
        IDictionary<string, string> GetCbsCardTypeSelectList();
        ...
        PhoneTypeEntity GetPhoneTypeByCbsCode(string electronicAddressCode);
