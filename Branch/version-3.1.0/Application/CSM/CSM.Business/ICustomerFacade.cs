...
namespace CSM.Business
{
    public interface ICustomerFacade : IDisposable
    {
        ...
        //List<CustomeEntity> GetCustomerByPhoneNo(int? customerId, List<string> lstPhoneNo);
        ...
        CustomerContactEntity GetCustomerContact(string customerType, string customerId, string customerNumber);
