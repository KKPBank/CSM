...
namespace CSM.Business
{
    public class CommonFacade : ICommonFacade
    {
        ...
        public TitleEntity GetTitleByCode(string titleCode, string Language)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            
            TitleEntity ret = new TitleEntity();
            ret = (from x in _commonDataAccess.GetActiveTitle()
                   where x.CbsTitleCode.Equals(titleCode) && x.Language == Language.ToUpper(CultureInfo.InvariantCulture)
                   select new TitleEntity
                   {
                       TitleId = x.TitleId,
                       TitleName = x.TitleName,
                       Language = x.Language,
                       CbsTitleCode = x.CbsTitleCode
                  }).FirstOrDefault();

            return (ret != null ? ret : new TitleEntity { TitleName = "" });
        }

        public TitleEntity GetTitleById(int titleId, string Language)
        {
            _commonDataAccess = new CommonDataAccess(_context);

            TitleEntity ret = new TitleEntity();
            ret = (from x in _commonDataAccess.GetActiveTitle()
                   where x.TitleId==titleId && x.Language == Language.ToUpper(CultureInfo.InvariantCulture)
                   select new TitleEntity
                   {
                       TitleId = x.TitleId,
                       TitleName = x.TitleName,
        ...
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetBankByBankNo(bankNo);
        }

        public CbsProvinceEntity GetProvinceByCode(string provinceCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            CbsProvinceEntity ret = new CbsProvinceEntity();
            ret = _commonDataAccess.GetProvinceByCode(provinceCode);
            return (ret != null ? ret : new CbsProvinceEntity { ProvinceName = "" });
        }

        public CbsDistrictEntity GetDistrictByCode(string districtCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            CbsDistrictEntity ret = new CbsDistrictEntity();
            ret = _commonDataAccess.GetDistrictByCode(districtCode);
            return (ret != null ? ret : new CbsDistrictEntity { DistrictName = "" });
        }

        public CbsSubDistrictEntity GetSubDistrictByCode(string subdistrictCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            CbsSubDistrictEntity ret = new CbsSubDistrictEntity();
            ret = _commonDataAccess.GetSubDistrictByCode(subdistrictCode);
            return (ret != null ? ret : new CbsSubDistrictEntity { SubDistrictName = "" });
        }

        public CbsCountryEntity GetCbsCountryByCode(string countryCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            CbsCountryEntity ret = new CbsCountryEntity();
            ret = _commonDataAccess.GetCbsCountryByCode(countryCode);
            return (ret != null ? ret : new CbsCountryEntity { CountryNameTH = "", CountryNameEN = "" });
        }
        ...
        public IDictionary<string, string> GetCbsCardTypeSelectList()
        {
            _commonDataAccess = new CommonDataAccess(_context);
            var lst = _commonDataAccess.GetCbsCardTypeList();
            return (from x in lst
                    select new
                    {
                        key = x.CardTypeID.ToString(),
                        value = x.CardTypeName
                    }).ToDictionary(t => t.key, t => t.value);
        }
        ...
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetSubscriptTypeById(subscriptTypeId);
        }

        //public SubscriptTypeEntity GetSubscriptTypeByTypeCode(string IDTypeCode)
        //{
        //    _commonDataAccess = new CommonDataAccess(_context);
        //    return _commonDataAccess.GetSubscriptTypeByTypeCode(IDTypeCode);
        //}
        ...
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsBranchByCode(cbsBranchCode);
        }

        public IEnumerable<BranchEntity> GetCbsBranchList()
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsBranchList();
        }
        ...
        public bool GetFlagCbsSaveLog()
        {
            var paramEntity = this.GetCacheParamByName(Constants.ParameterName.CbsSaveLog);
            return (paramEntity != null) ? (paramEntity.ParamValue == "Y" ? true : false) : true;
        }
        ...
        public dynamic GetHeaderByServiceName<T>(string serviceName)
        {
            ...
            if (typeof(T) == typeof(Header))
            {
                result = query.Select(x => new Header
                {
                    ...
                    transaction_date = today.FormatDateTime("yyyy-MM-dd HH:mm:ss"),
        ...
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetConfigAccountStatus(accountStatusValue);
        }

        public CbsCustTypeEntity GetCbsCustTypeByCode(string custTypeCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsCustTypeByCode(custTypeCode);
        }

        public CbsCardTypeEntity GetCbsCardTypeByCode(string cardTypeCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsCardTypeByCode(cardTypeCode);
        }

        public CbsCardTypeEntity GetCbsCardTypeById(int cardTypeId)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsCardTypeById(cardTypeId);
        }
        ...
        public int GetCASAStatementHisMonth()
        {
            ParameterEntity paramEntity = this.GetCacheParamByName(Constants.ParameterName.CASAStatementHisMonth);
            return (paramEntity != null) ? paramEntity.ParamValue.ToNullable<int>().Value : 6;
        }

        #endregion

        #region "CBS Mapping Master Data"
        public RelationshipEntity GetRelationshipByCbsCode(string cbsRelationshipCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetRelationshipByCBSCode(cbsRelationshipCode);
        }
        public AccountTypeEntity GetAccountTypeByCode(string systemCode, string accountTypeCode, string accountType)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetAccountTypeByCode(systemCode, accountTypeCode, accountType);
        }
        public AddressTypeEntity GetAddressTypeByCode(string addressTypeCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetAddressTypeByCode(addressTypeCode);
        }
        public AddressFormatEntity GetAddressFormatByCode(string addressFormatCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetAddressFormatByCode(addressFormatCode);
        }
        public AreaCodeEntity GetAreaCodeByCode(string areaCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetAreaCodeByCode(areaCode);
        }
        public PhoneTypeEntity GetPhoneTypeByCbsCode(string electronicAddressCode)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetPhoneTypeByCbsCode(electronicAddressCode);
        }
        ...
        public static int GetWSMaxReturnRows()
        {
            int maxRows;
            string cfg;
            using (var facade = new CommonFacade())
            {
                cfg = facade.GetValueParamByName(Constants.ParameterName.WSMaxReturnRows);
            }
            if (int.TryParse(cfg, out maxRows))
                return maxRows;
            return 1000;
        }
        ...
        public int[] GetCheckMailToDelegateUsers() { return (new CommonDataAccess(_context)).GetCheckMailToDelegateUsers(); }

        public int[] GetUnCheckMailToDelegateUsers() { return (new CommonDataAccess(_context)).GetUnCheckMailToDelegateUsers(); }
