...
namespace CSM.Business
{
    public class BdwFacade : IBdwFacade
    {
        ...
        //public bool TestFunction(int numOfBdwContact, int numOfError, string messageError)
        //{

        //    BdwDataAccess bdw = new BdwDataAccess(_context);
        //    return bdw.SaveCompleteBdwContact(ref numOfBdwContact, ref numOfError, ref messageError);
        //}
    }
}
