...
namespace CSM.Common.Utilities
{
    public static class DateTimeHelpers
    {
        ...
        public static string ToDisplay(this DateTime? val, string pattern = Constants.DateTimeFormat.ReportDateTime, string nullDisplay = "")
        {
            return !val.HasValue ? nullDisplay : val.Value.FormatDateTime(pattern);
        }
