    ...
    public class ServiceRequestDataAccess : IServiceRequestDataAccess
    {
        ...
        public ServiceRequestSaveSrResult SaveServiceRequest(ServiceRequestForSaveEntity entity, bool isSaveDraft)
        {
            ...
            try
            {
                ...
                sr.CLOSE_USER = entity.CloseUserId;
                sr.CLOSE_USERNAME = entity.CloseUserName;
        ...
        public void UpdateServiceRequest(ServiceRequestNoDetailEntity newValue, DateTime now)
        {
            ...
            try
            {
                ...
                {
                    if (newValue.SrStatusId == Constants.SRStatusId.Closed && dbValue.CLOSE_DATE == null)
                    {
                ...
                dbValue.UPDATE_USER = newValue.UpdateUserId;
                if (dbValue.UPDATE_USER == null)
                {
                    dbValue.UPDATE_USERNAME = newValue.UpdateUserName;
                }
