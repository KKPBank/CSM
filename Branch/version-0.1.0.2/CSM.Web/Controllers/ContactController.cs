...
namespace CSM.Web.Controllers
{
    ...
    public class ContactController : BaseController
    {
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("List").ToInputLogString());
            ...
            try
            {
                ...
                Logger.Info(_logMsg.Clear().SetPrefixMsg("List").Add("CustomerId", custInfoVM.CustomerId).ToInputLogString());
            ...
            {
                Logger.Error("Exception occur:\n", ex);
                Logger.Info(_logMsg.Clear().SetPrefixMsg("List").Add("Error Message", ex.Message).ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        public ActionResult ManageContactRlat(ContactEditViewModel contactEditVM)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    contactEditVM.ContactList = _customerFacade.GetContactByPhoneNo(contactEditVM.ContactId, contactEditVM.FirstNameThai, contactEditVM.LastNameThai
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (contactRelationVM.ListIndex == null)
                    {
                        ...
                        if (TempData["CustomerInfo"] != null)
                        {
                            var custInfoVM = (CustomerInfoViewModel)TempData["CustomerInfo"];

                            //custContact.CustomerFullNameTh = custInfoVM.FullNameThai;
                            //custContact.CustomerFullNameEn = custInfoVM.FullNameEnglish;
