...
namespace CSM.Web.Controllers
{
    ...
    public class UserMonitoringController : BaseController
    {
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("InitSearch User Monitoring").ToInputLogString());
            try
            {
                return View();
            }
            catch (Exception ex)
            {
                ...
                Logger.Info(_logMsg.Clear().SetPrefixMsg("InitSearch User Monitoring").Add("Error Message", ex.Message).ToFailLogString());
        ...
        public ActionResult GetUserAndBranch()
        {
            ...
            {
                Logger.Error(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search Group Assign").ToFailLogString(), ex);
                return Json(new
                {
                    IsSuccess = false,
        ...
        public ActionResult SearchGroupAssign(GroupAssignSearchFilter searchFilter)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search Group Assign").ToSuccessLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search Group Assign").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search User Assign").ToInputLogString());
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search User Assign").ToSuccessLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring >> Search User Assign").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Modal Search Branch").ToInputLogString());
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Modal Search User").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search User").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Branch").ToInputLogString());
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Product").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Product").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Area").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Area").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Area (on Mapping)").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search Area (on Mapping)").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search SubArea").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Auto complete Search SubArea").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Transfer Service Request").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Transfer Service Request").ToFailLogString());
                return Json(new
                {
                    Valid = false,
                    data = string.Empty,
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring get ServiceRequest by All User ID").ToInputLogString());
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring search service request group").ToInputLogString());
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("User Monitoring search service request user").ToInputLogString());
