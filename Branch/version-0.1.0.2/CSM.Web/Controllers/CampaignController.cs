...
namespace CSM.Web.Controllers
{
    ...
    public class CampaignController : BaseController
    {
        ...
        public ActionResult List(int? customerId = null)
        {
            ...
            Logger.Info(_logMsg.Clear().SetPrefixMsg("List Recommended Campaign").Add("CustomerId", custInfoVM.CustomerId).ToInputLogString());
        ...
        [ValidateAntiForgeryToken]
        [CheckUserRole(ScreenCode.ViewCustomerCampaigns)]
        public ActionResult RecommendedCampaignList()
        {
            CustomerInfoViewModel custInfoVM = new CustomerInfoViewModel();
            ...
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Search Recommended Campaign").Add("CardNo", custInfoVM.CardNo.MaskCardNo()).ToInputLogString());
