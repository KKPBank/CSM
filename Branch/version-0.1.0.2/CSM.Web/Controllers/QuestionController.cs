...
namespace CSM.Web.Controllers
{
    ...
    public class QuestionController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("List Question").ToFailLogString());
        ...
        public JsonResult SaveQuestion(QuestionSaveViewModel questionSaveVM)
        {
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Question Save").ToFailLogString());
        ...
        public ActionResult Edit(int QuestionId)
        {
            ...
            list.QuestionIsActiveList.Add(new SelectListItem() { Text = "Active", Value = "true" });
            list.QuestionIsActiveList.Add(new SelectListItem() { Text = "Inactive", Value = "false" });
