...
namespace CSM.Web.Controllers
{
    ...
    public class TypeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("List Type").ToFailLogString());
        ...
        public JsonResult SaveType(TypeSaveViewModel typeSaveVM)
        {
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Type Save").ToFailLogString());
        ...
        public ActionResult SearchTypeList(TypeSearchFilter searchFilter)
        {
            ...
            {
                Logger.Info(_logMsg.Clear().SetPrefixMsg("Search Type").ToFailLogString());
                return Error(new HandleErrorInfo(ex, this.ControllerContext.RouteData.Values["controller"].ToString(),
                    this.ControllerContext.RouteData.Values["action"].ToString()));
            }
        }
