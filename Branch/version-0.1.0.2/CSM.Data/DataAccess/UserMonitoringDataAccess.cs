...
namespace CSM.Data.DataAccess
{
    public class UserMonitoringDataAccess
    {
        ...
        //private static readonly ILog Logger = LogManager.GetLogger(typeof(UserMonitoringDataAccess));
        ...
        public List<GroupAssignEntity> SearchGroupAssign(GroupAssignSearchFilter searchFilter)
        {
            ...
            var fromDate = searchFilter.AssignDateFromValue.HasValue ? searchFilter.AssignDateFromValue.Value.Date : (DateTime?) null;
            var toDate = searchFilter.AssignDateToValue.HasValue ? searchFilter.AssignDateToValue.Value.Date : (DateTime?)null;
        ...
        public List<UserAssignEntity> SearchUserAssign(UserAssignSearchFilter searchFilter)
        {
            ...
            var query = from user in _context.TB_R_USER
                        ...
                        where (userIds.Contains(user.USER_ID) && user.STATUS == 1)
            ...
            return query.Skip(startPageIndex).Take(searchFilter.PageSize).ToList<UserAssignEntity>();
        }
