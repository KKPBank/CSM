...
namespace CSM.Data.DataAccess
{
    public interface ICustomerDataAccess
    {
        ...
        bool SaveCallId(string callId, string phoneNo, string cardNo, string callType, int userId);
        ...
        List<AccountEntity> GetAccountGradeByName(string searchTerm, int pageSize, int pageNum);
        int GetAccountGradeCountByName(string searchTerm);
