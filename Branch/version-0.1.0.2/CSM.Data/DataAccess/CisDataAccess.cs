    ...
    public class CisDataAccess : ICisDataAccess
    {
                    ...
                    k =>
                    {
                        var lstcisCorporate = from cisCorporate in cisCorporates.Skip(k * pageSize).Take(pageSize)
                                              ...
                                              new TB_I_CIS_CORPORATE
                                              {
                                                  ...
                                                  CREATED_DATE = cisCorporate.CreatedDate,
                                                  CREATED_BY = cisCorporate.CreatedBy,
                                                  UPDATED_BY = cisCorporate.UpdatedBy,
                                                  UPDATED_DATE = cisCorporate.UpdatedDate,
                        ...
                        SqlConnection con = new SqlConnection(WebConfig.GetConnectionString("CSMConnectionString"));
                    ...
                    k =>
                    {
                        var lstIndividual = from cisIndividual in cisIndividuals.Skip(k * pageSize).Take(pageSize)
                                            ...
                                            new TB_I_CIS_INDIVIDUAL
                                            {
                                                ...
                                                CREATED_DATE = cisIndividual.CreatedDate,
                                                CREATED_BY = cisIndividual.CreatedBy,
                                                UPDATE_DATE = cisIndividual.UpdateDate,
                                                UPDATED_BY = cisIndividual.UpdatedBy,
                    ...
                    try
                    {
                        if (cisProductGroups != null && cisProductGroups.Count > 0)
                        {
                            ...
                            foreach (CisProductGroupEntity cisProductGroup in cisProductGroups)
                            {
                                ...
                                dbProductGroup.ENITY_CODE = cisProductGroup.EntityCode;
                    ...
                    k =>
                    {
                        var lstSubscription = from cisSubscription in cisSubscriptions.Skip(k * pageSize).Take(pageSize)
                                              ...
                                              new TB_I_CIS_SUBSCRIPTION
                                              {
                                                  ...
                                                  CREATED_DATE = cisSubscription.CreatedDate,
                                                  CREATED_BY = cisSubscription.CreatedBy,
                                                  CREATED_CHANNEL = cisSubscription.CreatedChanel,
                                                  UPDATED_DATE = cisSubscription.UpdatedDate,
                                                  UPDATED_BY = cisSubscription.UpdatedBy,
                    ...
                    try
                    {
                        if (cisDistricts != null && cisDistricts.Count > 0)
                        {
                            ...
                            foreach (CisDistrictEntity cisDistrict in cisDistricts)
                            {
                                ...
                                dbDistrict.DISTRIC_CODE = cisDistrict.DistrictCode;
        ...
        public bool SaveCisSubscribeAddress(List<CisSubscribeAddressEntity> cisSubscribeAdds)
        {
            ...
            try
            {
                ...
                {
                    _context.Database.ExecuteSqlCommand("DELETE FROM TB_I_CIS_SUBSCRIBE_ADDRESS");
                    this.Save();
                    ...
                    k =>
                    {
                        var lstSubscribeAdd = from cisSubscribeAdd in cisSubscribeAdds.Skip(k * pageSize).Take(pageSize)
                                              select
                                              new TB_I_CIS_SUBSCRIBE_ADDRESS
                                              {
                                                  ...
                                                  PROVICE_CODE = cisSubscribeAdd.ProvinceCode,
                                                  ...
                                                  SUBSC_CODE = cisSubscribeAdd.SubscrCode,
                        ...
                        SqlConnection con = new SqlConnection(WebConfig.GetConnectionString("CSMConnectionString"));
                        SqlBulkCopy bc = new SqlBulkCopy(con.ConnectionString, SqlBulkCopyOptions.TableLock);
                        bc.DestinationTableName = "TB_I_CIS_SUBSCRIBE_ADDRESS";
                        bc.BatchSize = dt.Rows.Count;
                        con.Open();
                        bc.WriteToServer(dt);
                        bc.Close();
        ...
        public bool SaveCisSubscribePhone(List<CisSubscribePhoneEntity> cisSubscribePhones)
        {
            ...
            try
            {
                ...
                {
                    _context.Database.ExecuteSqlCommand("DELETE FROM TB_I_CIS_SUBSCRIBE_PHONE");
                    this.Save();
                    ...
                    k =>
                    {
                        var lstSubscribePhone = from cisSubscribePhone in cisSubscribePhones.Skip(k * pageSize).Take(pageSize)
                                                ...
                                                new TB_I_CIS_SUBSCRIBE_PHONE
                                                {
                                                    ...
                                                    CRAATE_BY = cisSubscribePhone.CreatedBy,
                        ...
                        SqlConnection con = new SqlConnection(WebConfig.GetConnectionString("CSMConnectionString"));
                        SqlBulkCopy bc = new SqlBulkCopy(con.ConnectionString, SqlBulkCopyOptions.TableLock);
                        bc.DestinationTableName = "TB_I_CIS_SUBSCRIBE_PHONE";
                        bc.BatchSize = dt.Rows.Count;
                        con.Open();
                        bc.WriteToServer(dt);
                        bc.Close();
        ...
        public bool SaveCisSubscribeEmail(List<CisSubscribeMailEntity> cisSubscribeMails)
        {
            ...
            try
            {
                ...
                {
                    _context.Database.ExecuteSqlCommand("DELETE FROM TB_I_CIS_SUBSCRIBE_EMAIL");
                    this.Save();
                    ...
                    k =>
                    {
                        ...
                        SqlConnection con = new SqlConnection(WebConfig.GetConnectionString("CSMConnectionString"));
                        SqlBulkCopy bc = new SqlBulkCopy(con.ConnectionString, SqlBulkCopyOptions.TableLock);
                        bc.DestinationTableName = "TB_I_CIS_SUBSCRIBE_EMAIL";
                        bc.BatchSize = dt.Rows.Count;
                        con.Open();
                        bc.WriteToServer(dt);
                        bc.Close();
        ...
        public List<CisCorporateEntity> GetCISCorExport()
        {
            var query = (from cor in _context.TB_I_CIS_CORPORATE.AsNoTracking()
                         ...
                         select new CisCorporateEntity
                         {
                             ...
                             Stock = cor.STOCK,
                             CreatedDate = cor.CREATED_DATE,
                             CreatedBy = cor.CREATED_BY,
                             UpdatedDate = cor.UPDATED_DATE,
                             UpdatedBy = cor.UPDATED_BY
                         });
        ...
        public List<CisIndividualEntity> GetCISIndivExport()
        {
            var query = (from indiv in _context.TB_I_CIS_INDIVIDUAL.AsNoTracking()
                         ...
                         select new CisIndividualEntity
                         {
                             ...
                             CreatedDate = indiv.CREATED_DATE,
                             CreatedBy = indiv.CREATED_BY,
                             UpdateDate = indiv.UPDATE_DATE,
                             UpdatedBy = indiv.UPDATED_BY
                         });
        ...
        public List<CisSubscriptionEntity> GetCisSubscriptionExport()
        {
            var query = (from sub in _context.TB_I_CIS_SUBSCRIPTION.AsNoTracking()
                         ...
                         select new CisSubscriptionEntity
                         {
                             ...
                             CreatedChanel = sub.CREATED_CHANNEL,
                             UpdatedDate = sub.UPDATED_DATE,
                             UpdatedBy = sub.UPDATED_BY,
        ...
        {
            var query = (from address in _context.TB_I_CIS_SUBSCRIBE_ADDRESS.AsNoTracking()
                         ...
                         select new CisSubscribeAddressEntity
                         {
                             ...
                             ProvinceCode = address.PROVICE_CODE,
        ...
        {
            var query = (from phone in _context.TB_I_CIS_SUBSCRIBE_PHONE.AsNoTracking()
        ...
        {
            var query = (from email in _context.TB_I_CIS_SUBSCRIBE_EMAIL.AsNoTracking()
        ...
        private void UpdateMasterTitle()
        {
            ...
            {
                var title = _context.TB_M_TITLE.FirstOrDefault(x => x.TITLE_NAME.Equals(item));
            ...
            {
                var title = _context.TB_M_TITLE.FirstOrDefault(x => x.TITLE_NAME.ToUpper().Equals(item.ToUpper()));
                    ...
                    try
                    {
                        if (cisCustomerEmails != null && cisCustomerEmails.Count > 0)
                        {
                            ...
                            foreach (CisCustomerEmailEntity cisCustomerEmail in cisCustomerEmails)
                            {
                                ...
                                dbCustomer.CREATED_DATE = cisCustomerEmail.CreatedDate;
                                dbCustomer.CREATED_BY = cisCustomerEmail.CreatedBy;
                                dbCustomer.UPDATED_DATE = cisCustomerEmail.UpdatedDate;
                                dbCustomer.UPDATED_BY = cisCustomerEmail.UpdatedBy;
