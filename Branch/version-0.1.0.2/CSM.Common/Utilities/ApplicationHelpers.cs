...
namespace CSM.Common.Utilities
{
    public static class ApplicationHelpers
    {
        ...
        {
            var validateUserName = WebConfig.GetTaskUsername();
            var validatePassword = WebConfig.GetTaskPassword();
        ...
        public static string StripHtmlTags(string html)
        {
            ...
            htmldoc.DocumentNode.Descendants().Where(n => n.Name == "script" || n.Name == "style" || n.Name == "meta").ToList().ForEach(n => n.Remove());
            //string s = Regex.Replace(htmldoc.DocumentNode.InnerText.ReplaceBreaks(), @"<[^>]+>|&nbsp;", string.Empty).NullSafeTrim();
            ...
            {
                Logger.InfoFormat("I:--START--:--Strip Html Tags--:Invalid HTML/{0}", html);
            }
        ...
        public static string GenerateFileName(string documentFolder, string fileExtension, int attachmentSeq)
        {
            ...
            string year = DateTime.Now.FormatDateTime("yy");
            ...
            return string.Format("{0}\\{1}\\{2}{3}", folderYear, folderMonth, fileName, fileExtension);
        }
        ...
        private static string GetDigit(string value)
        {
            ...
            return (digit % 10).ConvertToString();
        }
