    ...
    public class CommonFacade : ICommonFacade
    {
        ...
        public TitleEntity GetTitleByCode(string titleCode, string Language)
        {
            ...
            ret= (from x in _commonDataAccess.GetActiveTitle()
                  where x.CBSTitleCode.Equals(titleCode) && x.Language == x.Language.ToUpper(CultureInfo.InvariantCulture)
        ...
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetConfigCasaAccountStatus(casaAccountStatusValue);
        }

        public CbsCustomerCategoryEntity GetCbsCustomerCategory(string customerCatetoryValue)
        {
            _commonDataAccess = new CommonDataAccess(_context);
            return _commonDataAccess.GetCbsCustomerCategory(customerCatetoryValue);
        }
