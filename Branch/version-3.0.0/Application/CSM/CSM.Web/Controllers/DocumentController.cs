    ...
    public class DocumentController : BaseController
    {
        ...
        public ActionResult List(string encryptedString)
        {
            try
            {
                ...
                Logger.Info(_logMsg.Clear().SetPrefixMsg("List Document").Add("CustomerId", customerId).Add("CustomerNumber", customerNumber).ToInputLogString());
                ...
                {
                    documentVM.CustomerInfo = (CustomerInfoViewModel)TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()]; //this.MappingCustomerInfoView(customerId.Value);
                    TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()] = documentVM.CustomerInfo;
                }
                ...
                documentVM.SearchFilter = new AttachmentSearchFilter
                {
                    ...
                    CardNo = documentVM.CustomerInfo.CardNo,
                    SubsTypeName = documentVM.CustomerInfo.SubscriptType.SubscriptTypeName,
                    PageNo = 1,
        ...
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("List CustomerAttachment").Add("CustomerId", searchFilter.CustomerId).Add("CustomerNumber", searchFilter.CustomerNumber).ToInputLogString());
        ...
        [ValidateAntiForgeryToken]
        [CheckUserRole(ScreenCode.ViewCustomerDocument)]
        public ActionResult InitEdit(int? attachmentId, int? customerId, decimal? customerNumber, string documentLevel)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    attachVM.CustomerNumber = customerNumber;
        ...
        public ActionResult Edit(AttachViewModel attachVM)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    attach.CustomerNumber = attachVM.CustomerNumber;
