    ...
    public class CampaignController : BaseController
    {
        ...
        public ActionResult List(string encryptedString)
        {
            ...
            try
            {
                ...
                {
                    campaignVM.CustomerInfo = (CustomerInfoViewModel)TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()];
                    TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()] = campaignVM.CustomerInfo;
                }
        ...
        public ActionResult CampaignList(int? customerId, decimal? customerNumber)
        {
            Logger.Info(_logMsg.Clear().SetPrefixMsg("Search Campaign").Add("CustomerId", customerId).Add("CustomerNumber",customerNumber).ToInputLogString());
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(campaignVM.CustomerInfo.CardNo))
                    {
                        ...
                        campaignVM.CampaignList = _campaignFacade.GetCampaignListByCustomer(_auditLog, campaignVM.CustomerInfo.CardNo,
