...
namespace CSM.Web.Controllers
{
    public class MenuNavigatorController : BaseController
    {
        ...
        public ActionResult CustomerTab(string selectedTab, int? customerId = 0, decimal? customerNumber = 0)
        {
            _commonFacade = new CommonFacade();
            List<MenuEntity> customerTab = _commonFacade.GetCacheCustomerTab(selectedTab, customerId, customerNumber);
