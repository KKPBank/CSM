    ...
    public class ContactController : BaseController
    {
        ...
        public ActionResult List(string encryptedString)
        {
            ...
            try
            {
                ...
                {
                    contactVM.CustomerInfo = (CustomerInfoViewModel)TempData["CustomerInfo" + customerId.ToString() + customerNumber.ToString()]; //this.MappingCustomerInfoView(customerId.Value);
                ...
                //contactVM.ContactList.Where(w => w.AccountNo != null && casaType.Contains(w.AccountType)).ToList()
        ...
        AccountEntity MappingCASAAccountEntity(string AccountNumber, string CustomerNumber)
        {
            ...
            InquiryCASAAccountDetailResponse res = pd.InquiryCASAAccountDetailResponseWS(AccountNumber, CustomerNumber);
            if (res.Header.AccountInfo != null)
            {
                ...
                result = new AccountEntity
                {
                    ...
                    AccountStatus = (acc.Status.ToString() == "A" ? "A" : "I")
                };
            }
            else {
                result = new AccountEntity
        ...
        public ActionResult InitEditContactRelationship(string jsonData)
        {
            ...
            try
            {
                ...
                if (contactRelationVM.ListIndex != null)
                {
                    ...
                    contactRelationVM.AccountNo = selected.Account.AccountNo;
                ...
                if (contactRelationVM.CustomerId != null && contactRelationVM.CustomerNumber != null)
                {
                    ...
                    else if (contactRelationVM.CustomerNumber.Value > 0)
                    {
                        ...
                        vPaging.PageSize = _commonFacade.GetPageSizeStart();

                        listAccount = pd.InquiryCustomerAccountSummaryWS(contactRelationVM.CustomerNumber.Value, vPaging).ToList();
                    }
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var objCheckDup =
                        contactRelationVM.ContactRelationshipList.FirstOrDefault(
                            x => x.Account.AccountNo == contactRelationVM.AccountNo);
                    if (objCheckDup != null && custContact.Account.AccountNo != objCheckDup.Account.AccountNo)
                    {
