...
public class BatchRuleAssign extends AbstractBatch{
...
//				}
			...
			log.error("init BatchRuleAssign", ex);
			init();
		}
	}
	...
	public void run(String... args){
		try{
			init();
			final RuleEngineAssign runner				= new RuleEngineAssign(args);
	...
	public static void main(String[] args) {
		System.out.println("=========== START Initial BatchRuleAssign ============");
		BatchRuleAssign test = new BatchRuleAssign();
		test.run(args);
		System.out.println("=========== END Initial BatchRuleAssign ============");
	}
}
