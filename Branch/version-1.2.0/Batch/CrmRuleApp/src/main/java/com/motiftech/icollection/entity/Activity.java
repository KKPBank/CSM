...
public class Activity implements Serializable{
	...
	@Column(name = "SR_ACTIVITY_DESC", nullable = true, columnDefinition = "varchar(8000)")
	...
	@Column(name = "SR_ACTIVITY_EMAIL_SUBJECT", nullable = true, columnDefinition = "varchar(2000)")
	private String srActivityEmailSubject;
	
	@Column(name = "SR_ACTIVITY_EMAIL_BODY", nullable = true, columnDefinition = "varchar(8000)")
