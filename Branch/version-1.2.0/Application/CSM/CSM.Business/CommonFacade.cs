...
namespace CSM.Business
{
    public class CommonFacade : ICommonFacade
    {
        ...
        public IDictionary<string, string> GetReplyMailSelectList()
        {
            return this.GetReplyMailSelectList(null);
        }

        public IDictionary<string, string> GetReplyMailSelectList(string textName, int? textValue = null)
        {
            IDictionary<string, string> dic = new Dictionary<string, string>();
            ...
            dic.Add(Constants.ReplyMail.Y.ToString(CultureInfo.InvariantCulture), Resource.Ddl_ReplyMail_Y);
            dic.Add(Constants.ReplyMail.N.ToString(CultureInfo.InvariantCulture), Resource.Ddl_ReplyMail_N);
            return dic;
        }
        ...
        public List<MenuEntity> GetCacheCustomerTab(string selectedTab, int? customerId = null)
        {
            // Check the cache
            ...
            string encryptedstring = StringCipher.Encrypt(customerId.ConvertToString(), Constants.PassPhrase);
